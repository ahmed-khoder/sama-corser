...
export async function PUT(
    ...
    try {
        ...
        if (rest.heroOverlayColor !== undefined) data.heroOverlayColor = rest.heroOverlayColor || null;
        if (rest.heroOverlayOpacity !== undefined) data.heroOverlayOpacity = rest.heroOverlayOpacity;
        if (rest.heroBlurAmount !== undefined) data.heroBlurAmount = rest.heroBlurAmount;
