...
export default function CareersPage() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 overflow-hidden">
            ...
            {/* HERO SECTION                                              */}
            {/* ═══════════════════════════════════════════════════════════ */}
            <section className="relative min-h-[85vh] flex items-stretch overflow-hidden pt-20">
                {heroSlides.length > 0 && (
                ...
                <div className="container mx-auto px-4 relative z-20 flex-1 flex items-stretch">
                    <div className="grid lg:grid-cols-2 gap-16 items-stretch w-full py-6">
                        <motion.div
                            initial={{ opacity: 0, x: isRTL ? 50 : -50 }}
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.8 }}
                            className={`max-w-2xl relative flex flex-col justify-between ${isRTL ? 'text-right lg:order-2' : 'text-left'}`}
                        >
                            ...
                            <div>
                                ...
                                <motion.p
                                    ...
                                    className="text-lg md:text-xl text-white/80 leading-relaxed max-w-xl font-normal"
                                >
