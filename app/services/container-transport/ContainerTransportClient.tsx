...
const content = {
    hero: {
        ...
        descAr: 'هل تعاني من التأخير في الميناء، تلف البضائع، وتعقيدات الجمارك؟ سما لوجيستك تنقل أكثر من 10,000 حاوية سنوياً من بورسعيد بنسبة التزام 98% بالمواعيد. من ألواح الرخام في شق الثعبان إلى الحاويات الكاملة عبر مصر — نتولى المهام الثقيلة نيابةً عنك.',
    },
    stats: [
    ...
    painPoints: [
        {
            ...
            problemAr: 'حاويتك متوقفة في الميناء لأيام. رسوم الأرضيات تتراكم. والعميل يتصل يستفسر.',
            solutionEn: 'Pre-coordinated port operations. We clear containers in 24-48 hours — not days.',
            solutionAr: 'تنسيق مسبق مع الميناء. نُفسح الحاويات خلال 24-48 ساعة — وليس أيام.',
            titleEn: 'Port Delays',
        ...
        },
        {
            ...
            problemAr: 'ألواح الرخام تتكسر أثناء التحميل. المعدات الثقيلة تتعرض للخدش. بدون أي تأمين.',
        ...
        },
        {
            ...
            problemAr: 'إجراءات الجمارك تستغرق وقتاً طويلاً. مستندات خاطئة تعني تأخيراً إضافياً. ولا أحد يرد على الهاتف.',
            solutionEn: 'Dedicated customs team in Port Said. Complete documentation + clearance in 48 hours. Direct line, always.',
            solutionAr: 'فريق تخليص جمركي في بورسعيد. مستندات كاملة وإفراج خلال 48 ساعة. خط مباشر — دائماً.',
...
interface ContainerTransportClientProps {
    ...
    heroBlurAmount?: number | null;
}

export default function ContainerTransportClient({ clients, heroImage, heroOverlayColor, heroOverlayOpacity, heroBlurAmount }: ContainerTransportClientProps) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
            ...
            <header className="relative min-h-[80vh] flex items-center overflow-hidden">
                ...
                {/* Layer 2: Sharp background image (NO blur) */}
                <div className="absolute inset-0">
                    <Image
                        src={heroImage || "https://images.unsplash.com/photo-1605745341112-85968b19335b?auto=format&fit=crop&q=60&w=1920"}
                ...
                <div className="absolute inset-0" style={{ backgroundColor: heroOverlayColor || '#0369a1', opacity: heroOverlayOpacity ?? 0.2 }} />
                {/* Layer 4: Fog layer (blur applied to this layer only — image stays sharp) */}
                {(heroBlurAmount ?? 0) > 0 && (
                    <div className="absolute inset-0" style={{ backgroundColor: heroOverlayColor || '#0369a1', opacity: (heroOverlayOpacity ?? 0.2) * 0.5, filter: `blur(${heroBlurAmount}px)` }} />
                )}
                {/* Layer 5: Cinematic gradient */}
                ...
                <div className="container mx-auto px-4">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
                        ...
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-gray-900 dark:text-white mb-4">
                            {isRTL ? 'مشاكل لا ينبغي أن تتعامل معها' : 'Problems You Shouldn\'t Have to Deal With'}
                        </h2>
                        <p className="text-gray-600 dark:text-gray-400 text-base md:text-lg max-w-2xl mx-auto font-normal">
                            {isRTL
                                ? 'شهدنا هذه المشاكل تكلف الشركات ملايين. وهكذا نقضي عليها.'
                    ...
                    <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
                        {content.painPoints.map((pain, idx) => (
                            <motion.div
                                ...
                                whileInView="visible"
                                viewport={{ once: true }}
                                className="group relative bg-white dark:bg-slate-800/80 backdrop-blur-sm rounded-3xl shadow-xl border border-gray-100 dark:border-slate-700 hover:shadow-2xl hover:-translate-y-1 hover:border-brand-orange/30 transition-all duration-300 overflow-hidden"
                            >
                                {/* Top gradient bar */}
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="flex items-start gap-4 mb-6">
                                        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-orange/15 to-brand-gold/10 flex items-center justify-center group-hover:from-brand-orange group-hover:to-orange-600 transition-all duration-300 flex-shrink-0 shadow-lg">
                                            <pain.icon className="w-7 h-7 text-brand-orange group-hover:text-white group-hover:scale-110 transition-all duration-300" />
                                        </div>
                                        <h3 className="text-lg md:text-xl font-bold tracking-tight text-gray-900 dark:text-white pt-1 group-hover:text-brand-orange transition-colors">
                                            {isRTL ? pain.titleAr : pain.titleEn}
                                        </h3>
                                    </div>

                                    {/* Problem — muted "before" state */}
                                    <div className="flex items-start gap-2.5 mb-4">
                                        <div className="w-5 h-5 rounded-full bg-gray-200 dark:bg-slate-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                                ...
                                {/* Solution — confident "after" state with accent background */}
                                <div className="bg-gradient-to-br from-emerald-50 to-teal-50/50 dark:from-emerald-950/30 dark:to-teal-950/20 border-t border-emerald-100 dark:border-emerald-900/30 px-8 py-5">
                                    <div className="flex items-start gap-2.5">
                                        <div className="w-5 h-5 rounded-full bg-emerald-500 flex items-center justify-center flex-shrink-0 mt-0.5 shadow-sm shadow-emerald-500/30">
                                            <CheckCircle2 className="w-3.5 h-3.5 text-white" />
                                        </div>
                                        <p className="text-emerald-900 dark:text-emerald-200 text-sm leading-relaxed font-semibold">
