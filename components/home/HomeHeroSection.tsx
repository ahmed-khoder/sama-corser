            ...
            <div className="relative z-20 flex-1 flex flex-col md:justify-center pt-24 pb-2 md:pb-8 px-6 md:px-16 lg:px-24">
                ...
                <div className={`flex flex-col items-start flex-1 md:flex-initial ${isRTL ? 'text-right' : 'text-left'}`}>
                    ...
                    <motion.div
                        ...
                        className="flex flex-row gap-3 md:gap-4 mt-6 md:mt-0 mb-10 order-last md:order-none w-full md:w-auto"
                        style={{ direction: isRTL ? 'rtl' : 'ltr' }}
                    >
                        <Link
                            href="/contact?tab=quote"
                            onClick={() => trackEvent('quote_click', { page: 'home', location: 'hero' })}
                            className="flex-1 md:flex-none px-4 md:px-8 py-3.5 md:py-4 bg-brand-orange hover:bg-brand-darkOrange text-white font-semibold rounded-xl shadow-lg shadow-brand-orange/25 flex items-center justify-center gap-2 transition-all hover:scale-[1.03] hover:-translate-y-0.5 text-sm md:text-base"
                        >
                        ...
                        <Link
                            href="/services"
                            className="flex-1 md:flex-none px-4 md:px-8 py-3.5 md:py-4 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-all hover:scale-[1.03] hover:-translate-y-0.5 text-sm md:text-base"
                        >
